    ...
    <>
                          ...
                          {profiles.map(profile => (
                            <button
                              ...
                              onClick={() => {
                                ...
                                // switchProfile sets the hs-profile cookie server-side so
                                // all subsequent API requests carry the correct profile.
      ...
      {pinPendingProfile && (
        <PinLock
          ...
          onSuccess={() => {
            // PIN already verified by PinLock — now set the server-side cookie
            switchProfile(pinPendingProfile.id).catch(() => {});
