...
echo -e "${BOLD}  ==========================================${RESET}"
echo ""
echo -e "  Features: Multi-profile watch history, per-profile watchlists,"
echo -e "            per-profile playback settings, Kids Mode content filter"
echo ""
...
echo ""
echo -e "  ${CYAN}Data files (created on first run):${RESET}"
echo -e "     media-library.json       — your media library"
echo -e "     homestream-profiles.json — user profiles (up to 6)"
echo -e "     homestream-watchlist.json — per-profile My List"
echo -e "     homestream-config.json   — app configuration"
echo ""
