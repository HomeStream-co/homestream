...
import {
  ...
  Monitor, Server, Cpu, MemoryStick, Folder, Terminal, Info,
} from 'lucide-react';
...
const STEPS = [
  { id: 'sysreqs',  label: 'Requirements',  icon: Monitor },
          ...
          >
              ...
              <div className="flex flex-col gap-6">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    {[
                      { icon: Cpu, label: 'CPU', req: '2-core processor (4-core recommended for transcoding)', ok: true },
                      { icon: MemoryStick, label: 'RAM', req: '2 GB free RAM (4 GB recommended)', ok: true },
                      { icon: HardDrive, label: 'Disk', req: 'Space for your media library + ~500 MB for the app', ok: true },
                      { icon: Wifi, label: 'Network', req: 'Local network connection (no internet required for playback)', ok: true },
                    ].map(item => (
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {/* FFmpeg — bundled, no action needed */}
            ...
            {step === 6 && (
              <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-3">
                  <button onClick={() => setStep(5)} className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl border border-border text-muted-foreground hover:text-foreground text-sm transition-colors">
                    <ChevronLeft className="w-4 h-4" />Back
                  </button>
            ...
            {step === 8 && (
              <div className="flex flex-col gap-5">
                ...
                <div className="flex gap-3">
                  <button onClick={() => setStep(7)} className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl border border-border text-muted-foreground hover:text-foreground text-sm transition-colors">
                    <ChevronLeft className="w-4 h-4" />Back
                  </button>
