...
export const THEMES: ThemeDefinition[] = [
  ...
  },
  {
    id: 'electric-teal',
    name: 'Electric Teal',
    description: 'Black with vivid electric teal',
    swatch: '#006B6B',
    accentSwatch: '#004545',
    vars: {
      '--background': '185 30% 3%',
      '--foreground': '180 10% 94%',
      '--card': '185 28% 6%',
      '--card-foreground': '180 10% 94%',
      '--popover': '185 28% 6%',
      '--popover-foreground': '180 10% 94%',
      '--primary': '182 80% 22%',
      '--primary-foreground': '180 10% 94%',
      '--secondary': '185 18% 11%',
      '--secondary-foreground': '180 10% 94%',
      '--muted': '185 18% 11%',
      '--muted-foreground': '182 8% 48%',
      '--accent': '182 60% 30%',
      '--accent-foreground': '180 10% 94%',
      '--border': '185 16% 14%',
      '--input': '185 16% 14%',
      '--ring': '182 80% 22%',
      '--sidebar': '185 28% 6%',
      '--sidebar-foreground': '180 10% 94%',
      '--sidebar-primary': '182 80% 22%',
      '--sidebar-accent': '185 18% 11%',
      '--sidebar-border': '185 16% 14%',
    },
  },
  {
    id: 'amber-gold',
    name: 'Amber Gold',
    description: 'Black with rich amber gold',
    swatch: '#7A5500',
    accentSwatch: '#523800',
    vars: {
      '--background': '38 20% 3%',
      ...
      '--ring': '38 90% 26%',
      '--sidebar': '38 18% 6%',
      '--sidebar-foreground': '40 10% 94%',
      '--sidebar-primary': '38 90% 26%',
      '--sidebar-accent': '38 12% 11%',
      '--sidebar-border': '38 12% 14%',
    },
  },
  {
    id: 'slate',
    name: 'Slate',
    description: 'Black with cool steel slate',
    swatch: '#2A3A4A',
    accentSwatch: '#1A2530',
    vars: {
      '--background': '210 20% 3%',
      ...
      '--card': '210 18% 6%',
      '--card-foreground': '210 10% 94%',
      '--popover': '210 18% 6%',
      '--popover-foreground': '210 10% 94%',
      '--primary': '210 40% 28%',
      '--primary-foreground': '210 10% 94%',
      '--secondary': '210 14% 11%',
      '--secondary-foreground': '210 10% 94%',
      '--muted': '210 14% 11%',
      '--muted-foreground': '210 8% 48%',
      '--accent': '210 32% 36%',
      '--accent-foreground': '210 10% 94%',
      '--border': '210 14% 14%',
      '--input': '210 14% 14%',
      '--ring': '210 40% 28%',
      '--sidebar': '210 18% 6%',
      '--sidebar-foreground': '210 10% 94%',
      '--sidebar-primary': '210 40% 28%',
      '--sidebar-accent': '210 14% 11%',
      '--sidebar-border': '210 14% 14%',
    },
  },
  {
    id: 'crimson',
    name: 'Crimson',
    description: 'Black with vivid crimson red',
    swatch: '#8B0020',
    accentSwatch: '#5C0015',
    vars: {
      '--background': '350 18% 3%',
      '--foreground': '350 8% 94%',
      '--card': '350 16% 6%',
      '--card-foreground': '350 8% 94%',
      '--popover': '350 16% 6%',
      '--popover-foreground': '350 8% 94%',
      '--primary': '348 85% 26%',
      '--primary-foreground': '350 8% 94%',
      '--secondary': '350 10% 11%',
      '--secondary-foreground': '350 8% 94%',
      '--muted': '350 10% 11%',
      '--muted-foreground': '350 5% 48%',
      '--accent': '348 65% 34%',
      '--accent-foreground': '350 8% 94%',
      '--border': '350 10% 14%',
      '--input': '350 10% 14%',
      '--ring': '348 85% 26%',
      '--sidebar': '350 16% 6%',
      '--sidebar-foreground': '350 8% 94%',
      '--sidebar-primary': '348 85% 26%',
      '--sidebar-accent': '350 10% 11%',
      '--sidebar-border': '350 10% 14%',
    },
  },
];
