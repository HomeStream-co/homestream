  ...
  return (
    <div>
      ...
      <p className="text-[10px] text-muted-foreground/60 mt-1.5 px-1">
        Note: API keys and passwords are never exported or restored — you will need to re-enter them after a restore.
      </p>
    </div>
  );
}
              ...
              <div className="border-t border-border/50">
                ...
                <div className="px-4 pb-4 space-y-3">
                  <p className="text-[11px] text-muted-foreground leading-relaxed">
                    ...
                    Passwords and API keys are never included in the export.
                  </p>
